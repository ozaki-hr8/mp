...
with mp_pose.Pose(min_detection_confidence=0.5, min_tracking_confidence=0.5) as pose:
    while cap.isOpened():
        ...
        try:
            ...
            right_index = (wval-round(landmarks[mp_pose.PoseLandmark.RIGHT_INDEX.value].x*wval),round(landmarks[mp_pose.PoseLandmark.RIGHT_INDEX.value].y*hval))
        ...
        # cv2.circle(image,right_index,10,(0,255,0),-1)
